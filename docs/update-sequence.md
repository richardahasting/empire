...
2. **Fish.** A fishing class on a sea hex adds `fishing_rate × fertility ×
   ETUs × fishing_food_per_etu_per_fertility_point × efficiency` food to its
   hold, up to the hold. Sea fertility is generated by region
