 ...
 * scrapped.
 */
public record Ship(long id, int owner, String cls, String name, Coord at, double efficiency, Stocks stock, Coord dest, Lane lane, long built, String note, double tech, String mission, Coord home, double fuel, double crew, double mobility, java.util.Map<Integer, Long> firedOn, List<Coord> route, long ward) {
     ...
     */
    public Ship withFiredOn(java.util.Map<Integer, Long> f) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, lane, built, note, tech, mission, home, fuel, crew, mobility, f, route, ward); }
    ...
    public Ship withMobility(double m) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, lane, built, note, tech, mission, home, fuel, crew, Math.max(0, m), firedOn, route, ward); }
    ...
    public Ship withFuel(double f) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, lane, built, note, tech, mission, home, Math.max(0, f), crew, mobility, firedOn, route, ward); }
    public Ship withCrew(double c) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, lane, built, note, tech, mission, home, fuel, Math.max(0, c), mobility, firedOn, route, ward); }
    ...
    public Ship withAt(Coord c) { return new Ship(id, owner, cls, name, c, efficiency, stock, dest, lane, built, note, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    public Ship withEfficiency(double e) { return new Ship(id, owner, cls, name, at, e, stock, dest, lane, built, note, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    public Ship withStock(Stocks s) { return new Ship(id, owner, cls, name, at, efficiency, s, dest, lane, built, note, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    public Ship withDest(Coord d) { return new Ship(id, owner, cls, name, at, efficiency, stock, d, lane, built, note, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    public Ship withLane(Lane l) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, l, built, note, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    public Ship withNote(String n) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, lane, built, n, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    public Ship withName(String n) { return new Ship(id, owner, cls, n, at, efficiency, stock, dest, lane, built, note, tech, mission, home, fuel, crew, mobility, firedOn, route, ward); }
    /** A new mission, or none: any patrol route or escort charge from the last one is forgotten. */
    public Ship withMission(String m, Coord h) { return new Ship(id, owner, cls, name, at, efficiency, stock, dest, lane, built, note, tech, m, h, fuel, crew, mobility, firedOn, List.of(), 0); }
