// Design-system primitive: right-click menu. Same token classes as dropdown-menu.tsx.
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={cn(
        "z-50 min-w-[12rem] overflow-hidden rounded-[var(--radius)] border border-border bg-popover p-1 text-popover-foreground shadow-lg",
...
>(({ className, destructive, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive ? "text-destructive focus:bg-destructive/10 focus:text-destructive" : "text-popover-foreground",
