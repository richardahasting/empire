...
//   focus:bg-surface → focus:bg-accent
//   focus:text-ink-display → focus:text-accent-foreground
//   bg-hairline (separator) → bg-border
//   text-ink-muted (SVG icons) → text-muted-foreground
//   text-danger-display → text-destructive
//   bg-danger-faded → bg-destructive/10
//   focus:text-danger-display → focus:text-destructive
